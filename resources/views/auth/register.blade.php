    ...
    <div class="login-container">
        ...
        <div class="right">
            <div class="form-register">
                ...
                <p style="text-align: center; font-weight: bold; font-size: 25px; margin-bottom: 20px">Register</p>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                name="name" placeholder="Nama" value="{{ old('name') }}" required autocomplete="name" autofocus>
