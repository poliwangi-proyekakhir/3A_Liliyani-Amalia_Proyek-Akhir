    ...
    <div class="pasien_baru">
      <div class="form-register">
        ...
        <form method="POST" action="{{ route('pendaftaran.save') }}">
          ...
          <div class="row mb-3">
            <div class="col">
              <input id="nik" type="nik" class="form-control @error('nik') is-invalid @enderror"
                name="nik" maxlength="16" minlength="16" value="{{ old('nik') }}" placeholder="Nik" required autocomplete="nik">
          ...
          <input id="tipe" name="tipe" type="text" value="baru" hidden>
          ...
          <div class="row mb-3">
            <div class="col">
              <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror"
                name="nama" required autocomplete="nama" placeholder="Nama">
          ...
          <div class="row mb-3">
            <div class="col">
              <input id="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                name="tempat_lahir" required autocomplete="tempat_lahir" placeholder="Tempat Lahir">
          ...
          <div class="row mb-3">
            <div class="col">
              <input id="alamat" type='text' class="form-control @error('alamat') is-invalid @enderror"
                name="alamat" required autocomplete="alamat" placeholder="Alamat">
          ...
          <div class="row mb-3">
            <div class="col">
              <input id="whatsapp" type='text' class="form-control @error('whatsapp') is-invalid @enderror"
                name="whatsapp" required autocomplete="whatsapp" placeholder="Nomor Whatsapp">
